...
export function safeParseNode(input: unknown): z.SafeParseReturnType<unknown, A2NodeInput> {
	return A2NodeSchema.safeParse(input) as z.SafeParseReturnType<unknown, A2NodeInput>
}
